...
export function createFloor() {
    ...
    grasses.push(randomiser(grass, floor, 0, 220, 700, 150, 7, 4));
    grasses.push(randomiser(grass, floor, 0, -220, 700, 150, 7, 4));
    grasses.push(randomiser(grass, floor, 250, 0, 200, 60, 4, 1));
    grasses.push(randomiser(grass, floor, -250, 0, 200, 60, 4, 1));
    ...
    return { main: floor, trees: trees, smokes: smokes, clouds: clouds, butterflies: butterflies, bushes: bushes, grass: grasses };
}
